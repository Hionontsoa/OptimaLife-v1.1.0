 ...
 */
export const Reglages = ({ onLogout }: ReglagesProps) => {
  ...
  return (
    <div className="pb-24">
      ...
      <div className="px-6 space-y-6">
        ...
        <ProfilUtilisateur biometricEnabled={biometricEnabled} toggleBiometric={toggleBiometric} />
      ...
      <div className=' text-[12px] mt-5.5 text-center text-slate-600 p-2   dark:text-slate-400'><span className='p-2 bg-[#221255] border-[#730a8d] border-[1px] rounded-2xl' >OptimaLife v1.1.0</span></div>
